...
<div class="row">
  <div class="col-3 col-s-3 menu">
    <ul>
	  ...
	  <img src="images/coronavirusimg.png" style="display:none"/>
...
<script>
  ...
  <div class="col-6 col-s-9">
   ...
   <p>
	 <img src="images/coronavirus6.png" />
   </p>
    <p>


<h1>Reason #1:  COVID-19</h1><br><br>
The COVID-19 Pandemic has wreaked havoc all over the world and caused immeasurable damage to supply chain infrastructures and operations worldwide.  Even though millions of people are beginning to resume what they considered to be normal before the pandemic, there are still many who have not.  In addition, new COVID-19 variants with unknown effects are popping up almost three times a year making it appear that COVID will now be a permanent part of the human condition.  If this is the case, we can expect that until the vaccines are as effectives as today's flu medications, we will continue to see reduced operational capability in the world's supply chains and rising prices in the costs of goods and services.


		<br><br>
		<img src="images/next.png" onclick="window.location.href ='sidehustle2023_2.php'"/>
		<br><br>
  ...
  <div class="col-3 col-s-12">
    <div class="aside">
	  ...
	  <div class"col-3 col-2-12">
       <a href = "http://www.spoiledpickle.com/DunkingBooth2024/dunkingbooth.php"><img src = "images/dunkdesantis.jpeg"/></a><br><br>
