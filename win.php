...
<head><meta charset="UTF-8">
  ...
  <meta name="keywords" content="news,celebrities,politics,gossip,spoiled, pickle, win"><!-- Global site tag (gtag.js) - Google Analytics -->
...
<title>Win on Spoiled Pickle!</title>
</head>
<body>
...
<div class="row">
  ...
  <div class="col-6 col-s-9">
    <h1>Enter To Win!</h1>
   <p>
	<img src = "images/winit.png"/>
   </p>
    <p>

		In addition to offering exclusive commentary and content to our members, Spoiled Pickle is excited to offer its members exclusive opportunities to win prizes.  To be eligible, you must first be a member.  Second, you must sign up for which contests you would like to participate in.  Last, you must agree to Spoiled Pickle's Contestant User Agreement.  This agreement allows Spoiled Pickle to announce the winners of their contestants in order to encourage future participation in ongoing contests and to close out concluded contests.  Only signed up participants will be eligible for prizes.  Information regarding Spoiled Pickle's Prize Offerings will be forth coming so stay tuned.<br><br>
		
		<img src = "images/xboxx.png"/>
		<br><br>
		So Get Ready to Win!  
		<br><br>
