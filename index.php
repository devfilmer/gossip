...
<div class="row">
  <div class="col-3 col-s-3 menu">
	...
	<!--  <a href = "popquiz.php"><img src = "images/popquizgraphic4.gif" style="display:block"/></a>
      -->
	   ...
	   <h1><div style="margin	: auto"><a href="usyemenwar.php">The Battle Of Yemen 2024</a></div></h1>
      <p>
		  <a href="usyemenwar.php"><img src ="images/yemenmap.png" /></a>
	  </p><br><br>

	   <hr style="height: 5px" color="#C75000"><br>
	   <h1><div style="margin	: auto"><a href="byemrchristie.php">Governor Chis Christie Pushed Out Of Contention For President Of The United States</a></div></h1>
      <p>
		  <a href="byemrchristie.php"><img src ="images/christiecaricature.png" /></a>
	  </p><br><br>
	  
	  
	   <hr style="height: 5px" color="#C75000"><br>
	   <h1><div style="margin	: auto"><a href="bestcoffee.php">The Best Coffee You Will Every Have In Your Life.</a></div></h1>
      <p>
		  <a href="bestcoffee.php"><img src ="images/creamers/coffee1.png" /></a>
	  </p><br><br>
	  
	 	  	  <br><br>
	   <h1><div style="margin	: auto"><a href="http://www.spoiledpickle.com/trumpgaetzticket2024.php">Are You Ready?</a></div></h1>
      <p>
		     <a href = "http://www.spoiledpickle.com/trumpgaetzticket2024.php"><img src = "images/trumpgaetz.png"/></a>
	  </p><br><br> 
	  
	  
	  
	  	  <br><br>
	   <h1><div style="margin	: auto"><a href="http://www.spoiledpickle.com/santosfired.php">George Santos Finally Gets Busted!</a></div></h1>
      <p>
		     <a href = "http://www.spoiledpickle.com/santosfired.php"><img src = "images/santosbusted.png"/></a>
	  </p><br><br>
      ...
      <p>
		     <a href = "http://www.spoiledpickle.com/DunkingBooth2024/dunkingbooth.php"><img src = "images/dunkdesantis.jpeg"/></a>
		  	  	  ...
		  	  	  <hr style="height: 5px" color="#C75000"><br>
	   <h1><div style="margin	: auto"><a href="BloodInvaders/bloodinvaders2.php">Blood Invaders PC game now available for members only!</a></div></h1>
      <p>
		  <a href="BloodInvaders/bloodinvaders2.php"><img src ="BloodInvaders/bloodinvadersthumb.png" /></a>
	  </p><br><br>  
      ...
      <p>
		  <a href="ladiesreally.php"><img src ="images/ladiesreally.png" /></a>
	  	  	  	  ...
	  	  	  	  <hr style="height: 5px" color="#C75000"><br>
	   <h1><div style="margin	: auto"><a href="porkloinsmoked.php">Smoke Me A Pork Loin!</a></div></h1>
      <p>
		  <a href="porkloinsmoked.php"><img src ="images/smokedporkloin.png" /></a>
	  </p><br><br>
	...
	<hr style="height: 5px" color="#C75000"><br>
	  <p>
		  ...
		  <img border="0" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&ASIN=B0B5MH6TK9&Format=_SL250_&ID=AsinImage&MarketPlace=US&ServiceVersion=20070822&WS=1&tag=rougride2016-20&language=en_US" ></a>
	  </p>
  ...
  <div class="col-6 col-s-9">
    ...
    <p>With all the foolishness going on in the world.  We got to talk (gossip) about it.  Every now and then you can chalk it up to Darwinism but the truth is now adays it's starting to look like there's not a day that goes by where something dumb or extra doesn't happen.  <br><br>  Well, on this site, we're going to talk about it.  Hopefully, you'll enjoy our commentary.  With that, kick back, have glance and let's get into it.</p>
			 ...
			 <hr style="height: 5px" color="#C75000"><br>
	   <h1><div style="margin	: auto"><a href="trumpdisqualification.php">They're Out To Get Mr. Trump!</a></div></h1>
      <p>
		  <a href="trumpdisqualification.php"><img src ="images/trumpdisqualified.png" /></a>
	  </p><br><br>
	
	
	
		 <hr style="height: 5px" color="#C75000"><br>
	   <h1><div style="margin	: auto"><a href="brandonwilliamschristmasparty.php">Brandon Williams Got Pissed At The Christmas Party!</a></div></h1>
      <p>
		  <a href="brandonwilliamschristmasparty.php"><img src ="images/brandonwilliams.png" /></a>
	  </p><br><br>
  ...
  <div class="col-3 col-s-12">
    ...
    <div class="aside">
	  ...
	  <div class = "aside">
	  	  	  <hr style="height: 5px" color="#C75000"><br>
	   <h1><div style="margin	: auto"><a href="bootlicking101.php">Mr. Trump Was The Only 2024 GOP Candidate The Whole Time!</a></div></h1>
      <p>
		  <a href="../bootlicking101.php"><img src ="images/bootlicking.png" /></a>
	  </p><br><br>
	  	  ...
	  	  <hr style="height: 5px" color="#C75000"><br>
	   <h1><div style="margin	: auto"><a href="http://www.spoiledpickle.com/desantiswhatwereyouthinking.php">People Want To Know!</a></div></h1>
      <p>
		  <a href="http://www.spoiledpickle.com/desantiswhatwereyouthinking.php"><img src ="images/desantiswhat.png" /></a>
	  </p><br><br>
