...
<head><meta charset="UTF-8">
  ...
  <meta name="keywords" content="news,celebrities,politics,gossip,spoiled, pickle,Trump, Biden, Kamala, Van, Jones, Mary J. Blidge, Beyonce"><!-- Global site tag (gtag.js) - Google Analytics -->
...
<title>Man Van, You Done Messed Up This Time...</title>
</head>
<body>
...
<div class="row">
  <div class="col-3 col-s-3 menu">
    <ul>
		...
		<?php include 'picklemenu.php';?>
    	  ...
    	  <img src="images/manvan.png" style="display:none"/>
  ...
  <div class="col-6 col-s-9">
    <h1>Man Van, You Done Messed Up This Time!</h1>
   <p>
	<img src = "images/manvan.png">
   </p>
    <p>


	I think we can all say that every once in a while we like hearing Van Jones say what needs to be said... But here lately the brother has been off... So off that we can't let it slide when you don't know the difference between Mary J. Blige and Beyonce.  We have to stop for a minute and say what the hell?  You can't make a mistake like that on live television and then say "Drop the Mike".  Dude, when I heard that, I dropped my beer.  Van, you committed a heinous crime.  You've insulted the true sitting Queen of R&B... Ms. Mary J. Blige.  How do you confuse Work That with anything on the radio... No one, and I mean no one could ever pull this song off.  This song was made for her.  A mistake like this is enough for you to lose your player card.   <br><br>

The worst part is I don't think Beyonce cares for it either.  She might let it slide but I can't imagine what she thought when you pontificated on the idea that this was her song.  It's like confusing LL Cool J with Kool Mo Dee.  Or, worse, like confusing the Sugar Hill Gang with Force MDs.  Dude, you can't make mistakes like that.  I guess if Sarah Palin can see Russia from her house, you can believe that Beyonce sings Work That.  I guess Sting is singing Kiss songs and Lionel Richie is doing Temptations Rip Offs.  Hell, maybe Public Enemy will start doing Jodeci songs.  <br><br>

 ... If you don't know your music, don't try to break bad and say something that everyone is going to burn you on... Oh, let me drop the mic. <br><br>
