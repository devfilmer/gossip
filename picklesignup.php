...
<div class="row">
  <div class="col-3 col-s-3 menu">
    <ul>
	  ...
	  <img src="images/gold.png" style="display:none"/>
	<!--  <br>
...
-->
  ...
  <div class="col-6 col-s-9">
	  <span style="font-size: 9vw; color: white; font-weight: bolder; align-content: space-around">Subscribe</span><br>
    <h1>Choose Your Pickle!</h1>
   <p>
	<img src = "images/madpickle.png"/>
   </p>
    <p>
    	Below you have three choices for your Spoiled Pickle Sign Up.  With each offer, additional capabilities are added to your log on panel.  Enjoy.  <br><br>
<br><br>

<table st>
	<tr style="text-align:center; background:white"><td width="33%"><h3>Silver&nbsp;<br>Plan</h3></td><td width="30%"><h3>Gold<br>Plan</h3></td><td width="27%"><h3>Platinum<br>Plan</h3></td></tr>
	
	<tr style="text-align:center; vertical-align: text-top"><td style="vertical-align: top"><img src="images/silver.png" width="30%" /></td><td><img src ="images/gold.png" width="30%"/></td><td><img src="images/platinum.png" width="30%"/></td></tr>
	
	<tr style="text-align:left; background:white; vertical-align: top"><td style="width:33%"><h5><ul><li>Addition Members Only Article Content</li><br><li>Enter To Win</li></ul></h5></td>
		
		<td style="width:33%"><h5><ul><li>Addition Members Only Article Content</li><br><li>Enter To Win</li><br><li>What The People Think</li><br><li>Countdown Timers</li></ul></h5></td>
		
		<td style="width:33%"><h5><ul><li>Addition Members Only Article Content</li><br><li>Enter To Win</li><br><li>What The People Think</li><br><li>Countdown Timers</li><br><li>Conspiracy Theories</li></h5></td></tr>
	
	
		<tr style="text-align:center; background:white"><td><h3>$5.00</h3></td><td><h3>$7.00</h3></td><td><h3>$9.00</h3></td></tr>

	
	<tr style="text-align:center"><td><br><form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="KTQJTZERZFJZS">
<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_subscribeCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!" width="80%">
...
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="H2SW5QSAALP78">
<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_subscribeCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!" width="80%">
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
</form>
...
<td><br><form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="T8XC6K46UQVC8">
<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_subscribeCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!" width="80%">
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
</form>
