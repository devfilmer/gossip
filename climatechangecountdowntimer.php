...
<head><meta charset="UTF-8">
  ...
  <meta name="keywords" content="news,celebrities,politics,gossip,spoiled, pickle, climate, change, count, down, timer"><!-- Global site tag (gtag.js) - Google Analytics -->
...
<title>Climate Change Apocalypse Count Down Timer</title>
</head>
<body>
...
var countDownDate = new Date("Jan 1, 2100 15:37:25").getTime();
...
stub += "<td colspan= \'6\'>";
stub += "<h2>Climate Change Apocalypse Count Down Timer!</h2>";
stub += "</td>";
stub += "</tr>";
...
//-->
	...
	/////		
			...
			echo'Coming soon for members only:  Climate Change Apocalypse Countdown Timer';
		}
	   ?>

   <p>
	<img src = "images/badair.jpg"/>
   </p>
    <p>

		It's unfortunate that the scientist have completed the models that suggest that if humans do not do something extraordinary by 2050, <a href="https://www.usatoday.com/story/news/nation/2019/06/05/climate-change-apocalypse-could-start-2050-if-we-do-noting/1356865001/">we could be looking at an earth that is uninhabitable by 2100.</a>  No wonder Elon Musk is trying to get off the planet.  For the sake of mankind, I hope this count down never comes to fruition! <br><br>
