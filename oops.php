  ...
  <div class="col-6 col-s-9">
   ...
   <p>
    ...
    <p>
		...
		We're Sorry.  You've either attempted to visit a page you do not have access to or you're not logged in.  No worries.  Click Subscribe below to select your pickle and create a new account.  Or, you can select login below to sign in.  If . you already have an account and you want higher access, unsubscribe from your current account and sign up again at a higher subscription level. <br><br>
		
		
		<br><br><h2>
	  <a href = "login4.php"><div style="background:green; color:white; vertical-align:middle; align-content: center; font-size: 4.5vw">Log In</div></a></h2>
		<br><br>
		
	  <h2><a href = "picklesignup.php"><div style="background:red; color:white; vertical-align:middle; align-content: center; font-size: 4.5vw">Subscribe</div></a></h2>
