...
<head><script data-ad-client="ca-pub-9264799538995539" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><meta charset="UTF-8">
  ...
  <meta name="keywords" content="news,celebrities,politics,gossip,spoiled, pickle, Mike, Bloomberg, Elizabeth, Warren"><!-- Global site tag (gtag.js) - Google Analytics -->
...
<title>Bloomberg Body Slam!</title>
</head>
<body>
...
<div class="row">
  ...
  <div class="col-6 col-s-9">
    <h1>Bloomberg Body Slam!</h1>
   <p>
	<img src = "images/Bloomberg/bloomberg1.png"/>
   </p>
    <p>

		It’s got to be rough thinking you could pull out your wallet, make a couple of cute ads, put on a smile and run for president only to find out that those you are running against are willing to barbecue your ass to beat you.  Ms. Elizabeth Warren demonstrated her barbecuing skills during the last presidential debate in a way that will never be forgotten.  <a href ="https://www.worldstarhiphop.com/videos/video.php?v=wshh2f4568so87R56e1Q">It was a world star worthy performance</a> leaving Mr. Bloomberg looking like the perfect rotisserie chicken on national television.  <br><br>
		
		<img src = "images/Bloomberg/bloomberg5.png"/>
		<br><br>
      ...
      echo 'I mean it was like from the word go.  Ms. Warren slapped Bloomberg\'s ass like he had said something about her mamma.  She wasn\'t hearing his bull shit and the whole world got to see why it doesn\'t matter how much money you have in America.  This woman took Mr. Bloomberg down in less than three minutes.  She rattled off everything he\'s ever done wrong and destroyed his career, his reputation, and his name for good.  Now when you hear the name Bloomberg, it will never sound the same.  Bloomberg sounds like Hindenberg now.  I don\'t know how he stood there and took that but I guess when you are catching a beat down, you don\'t realize it until later.';
		}
		else{
			echo'Coming soon:  log in for more on this article.';
		}
	   ?>
