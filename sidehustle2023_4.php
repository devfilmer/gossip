...
<div class="row">
  <div class="col-3 col-s-3 menu">
    <ul>
	  ...
	  <img src="images/cryptochroniclesthumb2.png" style="display:none"/>
...
<h1>Reason #4:  Volatile Stock And Crypto Markets</h1><br><br>
In 2021, many experienced what might become recognized as Crypto euphoria.  The somewhat new asset class saw gains that were unprecedented and arguably a catalyst for NYSE and NASDAQ investing in stocks, bonds, and traditional commodities.  Sadly, the crypto crash of 2022 was nothing short of epic.  As well, traditional markets are suffering as wars rage around the globe and recession appears to be imminent for every super power on the planet.  

		<br><br>
		<img src="images/next.png" onclick="window.location.href ='sidehustle2023_5.php'"/>
		<br><br>
