...
<div class="row">
  <div class="col-3 col-s-3 menu">
    <ul>
	  ...
	  <img src="images/sidehustle.png" style="display:none"/>
...
<script>
  ...
  <div class="col-6 col-s-9">
   ...
   <p>
	 <img src="images/sidehustle.png" />
   </p>
    <p>


<h1>Conclusion: Everyone Needs A Side Hustle! </h1><br><br>
After reviewing the contents of this article, it should be clear that in the immediate future, help is not on the way.  There is no way we should be sitting back and waiting to see what happens.  In order to survive, we must adapt.  And in this case, that may mean getting a side hustle or a second job.  We don't need to wait until thing go awry.  They already have.  
