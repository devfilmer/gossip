...
<head><meta charset="UTF-8">
  ...
  <meta name="keywords" content="news,celebrities,politics,gossip,spoiled, pickle, social, security, count, down, timer"><!-- Global site tag (gtag.js) - Google Analytics -->
...
<title>Social Security Count Down Timer</title>
</head>
<body>
...
var countDownDate = new Date("Jan 1, 2037 15:37:25").getTime();
...
stub += "<td colspan= \'6\'>";
stub += "<h2>Social Security Count Down Timer!</h2>";
stub += "</td>";
stub += "</tr>";

stub += "<tr style=\"background:black; color: white; font-size: 1.3vw\">";
stub += "<td width= \'16%\'>";
stub += "<h2>Years</h2>";
stub += "</td>";
stub += "<td width= \'16%\'>";
...
stub += "<td width= \'16%\'>";
stub += "<h2>";
stub += Math.floor(num_years);
stub += "</h2>";
stub += "</td>";
stub += "<td width= \'16%\'>";
stub += "<h2>";
stub += Math.floor(num_months);
stub += "</h2>";
stub += "</td>";
stub += "<td width= \'16%\'>";
stub += "<h2>";
stub += Math.floor(num_days);
stub += "<h2>";
stub += "</td>";
...
//-->
   ...
   <p>
    ...
    <p>
		...
		It's amazing that after over 80 years of social security benefits being paid out to Americans, <a href="https://www.ssa.gov/policy/docs/ssb/v70n3/v70n3p111.html"> it's about to take a drastic cut that threatens the very quality of life of tomorrow's senior citizens.</a>  This fact published by the Social Security Administration would be the biggest breach of contract in American History between the Federal Government and American citizens. Will the U.S. Congress and U.S. Senate stand by and let it happen or will they do something to ensure they do not lose the public's trust? <br><br>
