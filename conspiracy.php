...
<title>Spoiled Pickle Conspiracy Page</title>
</head>
<body>
  ...
  <div class="col-6 col-s-9">
   ...
   <p>
    ...
    <p>
		...
		There's so much going on in the world that doesn't make since... that is unless you think about what might really be going on.  What is the real reason the same kinds of people continue to be elected to Congress, the Senate, and to the White House?  Why after women's suffrage, the civil rights movement, and the introduction of endless social programs are there so many minorities and women struggling to survive?  Shouldn't they be thriving by now?  This is the foundation for the line of thinking beneath Spoiled Pickle's Conspiracy Page.  <br><br>
		
		<img src = "images/Bloomberg/bloomberg5.png"/>
		<br><br>
		Here we will explore the potential reason for things that don't appear to have a viable explanation.  We will attempt to give insight into what might really be going on with some of the most unexplainable events that are occurring around the world.  So strap on your seat belt, there is certainly going to be turbulence.
		<br><br>
      ...
      echo 'Let\'s Dig In!';
			...
			echo'Coming Soon for Members Only:  log in for more on access.';
		}
	   ?>
