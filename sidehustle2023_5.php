...
<div class="row">
  <div class="col-3 col-s-3 menu">
    <ul>
	  ...
	  <img src="images/inflation.png" style="display:none"/>
...
<script>
  ...
  <div class="col-6 col-s-9">
   ...
   <p>
	 <img src="images/inflation.png" />
   </p>
    <p>


<h1>Reason #5:  Rising US Inflation</h1><br><br>
Despite the actions of the Executive and Legislative Branches of the United States, inflation has began to take a toll on the people.  Americans are struggling to pay their bills.  They are struggling to put food on the table.  And now it appears that even the once stable middle class is feeling the crunch.  They've gone from getting by to having to make hard choices.  Their eyes are widened when they go to the grocery store and it's anyone's guess what gas will cost from month to month.  This type of instability makes a very good point for having multiple streams of income.

		<br><br>
		<img src="images/next.png" onclick="window.location.href ='sidehustle2023_6.php'"/>
		<br><br>
